...
export class ObjectStorageService {
  ...
  getPublicObjectSearchPaths(): Array<string> {
    ...
    // Add private directory to search paths for migrated images
    if (privateDir && !paths.includes(privateDir)) {
      paths.push(privateDir);
    }
  ...
  // Gets the upload URL for PUBLIC objects (galería, actividades, banners)
